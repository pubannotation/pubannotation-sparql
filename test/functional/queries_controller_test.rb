...
class QueriesControllerTest < ActionController::TestCase
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post :create, query: { comment: @query.comment, graph: @query.graph, priority: @query.priority, sparql: @query.sparql, title: @query.title }
    end
  ...
  test "should update query" do
    put :update, id: @query, query: { comment: @query.comment, graph: @query.graph, priority: @query.priority, sparql: @query.sparql, title: @query.title }
    assert_redirected_to query_path(assigns(:query))
  end
